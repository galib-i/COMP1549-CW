...
public class MessageFormatterTest {
    ...
    private void assertMessageEquals(Message.Type type, String sender, String recipient, Object content, Message originalMessage) {
    ...
    void parse_ReturnsMessageObject_IfHasMapContent() {
        String messageString = formatMessage("USER_DETAILS_RESPONSE", SERVER_ID, USER_ID_1, "userId=%s,role=MEMBER,status=ACTIVE".formatted(USER_ID_1));
        Message parsed = MessageFormatter.parse(messageString);
