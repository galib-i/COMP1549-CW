...
public class ConnectionManagerTest {
    ...
    void connect_ThrowsIllegalArgumentException_IfConnectWithInvalidUserId() {
        ...
        assertIllegalArgumentException("#UserId!!!", VALID_SERVER_IP, VALID_SERVER_PORT, "User ID must be alphanumeric!");
    }
    ...
    void connect_ThrowsConnectException_IfConnnectToOfflineServer() {
        assertThrows(ConnectException.class, () -> connectionManager.connect(VALID_USER_ID, VALID_SERVER_IP, VALID_SERVER_PORT));
    }
    ...
    void connect_ThrowsIllegalArgumentException_IfUserIdAlreadyInUse() throws Exception {
        ...
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> connectionManager.connect(VALID_USER_ID, VALID_SERVER_IP, VALID_SERVER_PORT));
